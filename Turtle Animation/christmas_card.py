...
text.color("blue") 
text.penup() 
text.setposition(30,135) 
text.write("Happy Christmas", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(-125, -235) 
text.color("brown") 
text.write("SK Khandokar", font=("Avenir", 30, "bold")) 
# text.color("red") 
# text.write("KHANDOKAR", font=("Avenir", 25, "bold"), align="left") 
# text.setx(50) 
# text.setposition(70, 140) 
# text.write("from", font=("Apple Chancery", 10, "bold"), align="right") 
text.hideturtle() 
